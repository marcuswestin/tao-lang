...
/** compileOneTaoFileModule emits one RN TSX module with the preamble, imports, and top-level statements. */
function compileOneTaoFileModule(
  ...
  const { appShellImport, iconImport, navigationImport, navigationRuntimeImport, reactImport, taoDataImport } =
  ...
  result.append(compileNode(taoFile)`
    ...
    ${reactImport}${navigationImport}${navigationRuntimeImport}${appShellImport}${iconImport}${taoDataImport}${taoDesignImport}${importHeader} // ${
