...
8. Hand off to `project-8-finalize-merge` for the actual squash landing, main validation, push, remote feature branch archival under `archived/<feature-branch>`, and local feature branch/worktree deletion.
...
- Validation status.
- Roadmap status.
- Merge handoff to `project-8-finalize-merge`, including remote feature branch archival and local feature branch/worktree deletion after `main` is pushed.
