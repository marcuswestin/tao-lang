...
- 2026-05-29 implementation review: the branch also contains `6b24362` (`chore(skills): let Claude choose default model`), a companion workflow fix needed so project-review can use the local Claude CLI default model during implementation review.
