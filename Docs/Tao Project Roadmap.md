...
| -------- | ------------------------------------- | -------------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------- | ----------------------------------------------------- |
| 1        | Data Schema and Queries MVP           | Ready for plan | [Research](./Projects/Data%20Schema%20and%20Queries%20MVP%20Project%20Research.md)                                      | [Plan](./Projects/Data%20Schema%20and%20Queries/Queries%20MVP%20Plan.md)                                        | Run `project-3-write-project-plan`    | Plan the small InstantDB-targeted query/write sprint  |
| 2        | Navigation and routing                | Planned        | [Research](./Projects/Navigation%20and%20Routing%20Project%20Research.md)                                               | [Plan](./Projects/Navigation%20and%20Routing%20Project%20Plan.md)                                               | Run `project-4-review-project-plan`   | Review the navigation v1 implementation plan          |
