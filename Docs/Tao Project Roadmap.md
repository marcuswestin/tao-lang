...
| -------- | ------------------------------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| 1        | Data Schema and Queries MVP           | Reviewed implementation | [Research](./Projects/Data%20Schema%20and%20Queries%20MVP%20Project%20Research.md)                                      | [Plan](./Projects/Data%20Schema%20and%20Queries%20MVP%20Project%20Plan.md)                                      | Run `project-7-prepare-merge`         | Review fixes landed; run manual InstantDB service acceptance if credentials are available before merge |
