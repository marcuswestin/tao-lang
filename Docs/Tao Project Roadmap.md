...
| -------- | ------------------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------- | --------------------------------------------------------- |
| 1        | Data Schema and Queries MVP           | In implementation | [Research](./Projects/Data%20Schema%20and%20Queries%20MVP%20Project%20Research.md)                                      | [Plan](./Projects/Data%20Schema%20and%20Queries%20MVP%20Project%20Plan.md)                                      | Run `project-5-implement-project`     | Implement the small InstantDB-targeted query/write sprint |
...
- MVP remaining: active sprint is the reviewed query/write slice: `where`, `exists`/`missing`, ordering, `date` fields, and strict row-handle `update` through Memory and InstantDB. Broader data MVP remainder still includes `if`/`else`, relationship-heavy target app coverage, provider capability validation, and the literal target app path.
