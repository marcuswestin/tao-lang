...
| 4        | App-shell hardening                  | Implemented | -                                                                                                                       | [Plan](./Projects/App%20Shell%20Safe%20Area%20and%20Keyboard%20Project%20Plan.md)                               | Run manual device smoke before merge prep | Implementation review fixes applied; manual iOS/Android smoke pending before merge prep   |
...
- MVP remaining: finish the raw layout MVP, cover responsive/adaptive essentials, preserve React Native/Expo mapping, and review/merge the app-shell hardening branch.
...
- MVP remaining: review/merge app-shell hardening, shared runtime manifest parsing, compiled-app test helpers, web behavior, source maps, and runtime parity expectations.
