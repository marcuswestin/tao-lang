...
| -------- | ------------------------------------- | ----------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------- | --------------------------------------------------------- |
| 1        | Data Schema and Queries MVP           | Reviewed    | [Research](./Projects/Data%20Schema%20and%20Queries%20MVP%20Project%20Research.md)                                      | [Plan](./Projects/Data%20Schema%20and%20Queries%20MVP%20Project%20Plan.md)                                      | Run `project-5-implement-project`     | Implement the small InstantDB-targeted query/write sprint |
