...
| -------- | ------------------------------------- | ----------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------- | ----------------------------------------------------- |
| 1        | Data Schema and Queries MVP           | Implemented | [Research](./Projects/Data%20Schema%20and%20Queries%20MVP%20Project%20Research.md)                                      | [Plan](./Projects/Data%20Schema%20and%20Queries%20MVP%20Project%20Plan.md)                                      | Run `project-6-review-implementation` | Review the implemented query/write sprint             |
