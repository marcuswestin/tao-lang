...
- Different apps should end up with different defaults. For example, Tao may select from a library of UI themes using a deterministic hash of the project name, or generate tasteful app defaults programmatically.
